<template>
  <div class="oe-min-h-screen oe-bg-gray-50 oe-transition-colors oe-duration-300">
    <div class="oe-p-2 oe-mx-auto" v-if="dashboardData">
      ...
      <div class="oe-grid oe-grid-cols-1 lg:oe-grid-cols-12 oe-gap-6">
        <div class="lg:oe-col-span-8">
          <div v-if="dashboardData.active_onboardings" class="oe-mb-8">
             ...
             <div class="oe-space-y-4">
                <div v-for="emp in dashboardData.active_onboardings" :key="emp.id" class="oe-bg-white oe-rounded-2xl oe-p-5 oe-flex oe-items-center oe-gap-4 oe-shadow-sm oe-border oe-border-gray-100">
                   <div class="oe-w-12 oe-h-12 oe-rounded-2xl oe-bg-blue-100 oe-text-blue-700 oe-flex oe-items-center oe-justify-center">{{ emp.first_name[0] }}</div>
                   <div class="oe-flex-1">
                      <p class="oe-font-semibold oe-text-gray-900">{{ emp.first_name }} {{ emp.last_name }}</p>
                      <p class="oe-text-sm oe-text-gray-500">{{ emp.role }}</p>
                   </div>
                </div>
             </div>
          </div>
    ...
    <div v-else-if="loading" class="oe-flex oe-items-center oe-justify-center oe-h-screen">
      <div class="oe-text-gray-400">Loading super admin dashboard...</div>
    </div>
  </div>
</template>
