    ...
    <div class="oe-p-6 oe-mx-auto">
      <div class="oe-flex oe-justify-between oe-items-center oe-mb-8">
        <div>
          ...
          <p class="oe-text-gray-500">
            Task KPI and employee-wise workload overview
          </p>
        </div>
        <div class="oe-flex oe-gap-3">
          ...
          <div
            class="oe-flex oe-bg-white oe-p-1 oe-rounded-2xl oe-border oe-border-slate-200"
          >
            <button
              ...
              :class="
                activeTab === 'overview'
                  ? 'oe-bg-slate-900 oe-text-white'
                  : 'oe-text-slate-600 hover:oe-bg-slate-50'
              "
            >
              Overview
            </button>
      ...
      <div v-if="activeTab === 'overview'">
        <div v-if="dashboardData">
          <div
            class="oe-grid oe-grid-cols-1 md:oe-grid-cols-2 lg:oe-grid-cols-5 oe-gap-6 oe-mb-10"
          >
            <div
              v-for="(kpi, index) in kpis"
              :key="index"
              class="oe-bg-white oe-rounded-2xl oe-p-6 oe-shadow-sm oe-border oe-border-gray-100"
            >
              <div class="oe-flex oe-justify-between oe-items-start">
                ...
                <div
                  :class="kpi.iconBg"
                  class="oe-w-10 oe-h-10 oe-rounded-xl oe-flex oe-items-center oe-justify-center text-xl"
                >
                  {{ kpi.icon }}
                </div>
              </div>
        ...
        <div
          v-else-if="loading"
          class="oe-flex oe-items-center oe-justify-center oe-h-64"
        >
          <div
            class="oe-animate-spin oe-w-8 oe-h-8 oe-border-4 oe-border-blue-600 oe-border-t-transparent oe-rounded-full"
          ></div>
...
const kpis = computed(() => {
  ...
  return [
    {
      label: "Pending",
      value: dashboardData.value.task_counts.pending,
      icon: "⏳",
      iconBg: "oe-bg-amber-100",
    },
    {
      label: "In Progress",
      value: dashboardData.value.task_counts.inprogress,
      icon: "⚙️",
      iconBg: "oe-bg-blue-100",
    },
    {
      label: "On Hold",
      value: dashboardData.value.task_counts.hold,
      icon: "⏸️",
      iconBg: "oe-bg-slate-100",
    },
    {
      label: "Done",
      value: dashboardData.value.task_counts.done,
      icon: "✅",
      iconBg: "oe-bg-emerald-100",
    },
    {
      label: "Total",
      value: dashboardData.value.task_counts.total,
      icon: "📊",
      iconBg: "oe-bg-violet-100",
    },
  ];
});
