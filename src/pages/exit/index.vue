      ...
      <div class="oe-flex oe-justify-between oe-items-start mb-8">
        <div>
          ...
          <p class="oe-text-gray-500">
            Track resignation & offboarding workflows
          </p>
        </div>
        <button
          class="oe-bg-white oe-border oe-border-gray-300 oe-text-gray-700 hover:oe-bg-gray-50 oe-px-6 oe-py-3 oe-rounded-xl oe-flex oe-items-center oe-gap-2 oe-font-medium transition-colors shadow-lg shadow-gray-200"
        >
      ...
      >
        <div class="oe-flex oe-justify-between oe-items-center oe-mb-6">
          <div class="oe-flex oe-items-center oe-gap-3">
            ...
            <span
              class="oe-bg-amber-100 oe-text-amber-700 oe-px-4 oe-py-1.5 oe-rounded-lg oe-text-sm oe-font-medium"
            >
          ...
          <div class="oe-text-sm oe-text-gray-500">
            <span class="oe-font-medium"
              >{{ totalCompleted }}/{{ totalTasks }} tasks</span
            >
        ...
        <div class="oe-grid oe-grid-cols-1 lg:oe-grid-cols-12 oe-gap-6">
          ...
          <div class="lg:oe-col-span-6">
            <div
              ...
              :class="{
                'oe-border-emerald-200 oe-bg-emerald-50/30':
                  phase1Progress === 100,
              }"
            >
              <div
              ...
              >
                <div class="oe-flex oe-items-center oe-gap-4">
                  <div
                    ...
                    :class="
                      phase1Progress === 100
                        ? 'oe-bg-emerald-500 oe-text-white'
                  ...
                  <div>
                    <p class="oe-font-semibold">
                      Phase 1: Resignation & Discussion
                    </p>
                    <p class="oe-text-xs oe-text-gray-500">
                      Resignation submission and discussion
                    </p>
                  </div>
                </div>
                <div class="oe-flex oe-items-center oe-gap-3">
                  <span class="oe-text-sm oe-font-medium oe-text-gray-500"
              ...
              <div class="oe-px-6 mb-4">
                ...
                >
                  <div
                    class="oe-h-full oe-bg-emerald-500 oe-transition-all"
              ...
              <div v-if="openPhases[1]" class="oe-px-6 oe-pb-6 oe-space-y-3">
                ...
                >
                  <div class="oe-flex oe-items-center oe-gap-3 flex-1">
                    <span
                      class="oe-w-6 oe-h-6 oe-flex oe-items-center oe-justify-center oe-border-2 oe-rounded-full transition-colors"
                      :class="
                        task.status === 'Done'
                          ? 'oe-bg-emerald-500 oe-border-emerald-500 oe-text-white'
                          : 'oe-border-gray-300'
                      "
                    >
                      <svg
                    ...
                    <div>
                      <p
                        class="oe-font-medium oe-text-sm"
                        :class="{
                          'oe-line-through oe-text-gray-400':
                            task.status === 'Done',
                        }"
                      >
                        {{ task.title }}
                  ...
                  <TaskStatusBadge
                    :status="task.status"
                    @change="
                      (newStatus) => updateTaskStatus(phase1Tasks, i, newStatus)
                    "
                  />
                </div>
              </div>
              ...
              <div v-if="openPhases[2]" class="oe-px-6 oe-pb-6 oe-space-y-3">
                ...
                >
                  ...
                  <TaskStatusBadge
                    :status="task.status"
                    @change="
                      (newStatus) => updateTaskStatus(phase2Tasks, i, newStatus)
                    "
                  />
                </div>
              </div>
              ...
              >
                <div class="oe-flex oe-items-center oe-gap-4">
                  ...
                  <div>
                    ...
                    <p class="oe-text-xs oe-text-gray-500">
                      Handover documentation and sessions
                    </p>
                  </div>
                </div>
                <div class="oe-flex oe-items-center oe-gap-3">
              ...
              <div v-if="openPhases[3]" class="oe-px-6 oe-pb-6 oe-space-y-3">
                ...
                >
                  ...
                  <TaskStatusBadge
                    :status="task.status"
                    @change="
                      (newStatus) => updateTaskStatus(phase3Tasks, i, newStatus)
                    "
                  />
                </div>
              </div>
              ...
              >
                <div class="oe-flex oe-items-center oe-gap-4">
                  ...
                  <div>
                    ...
                    <p class="oe-text-xs oe-text-gray-500">
                      LWD calculation and confirmation
                    </p>
                  </div>
                </div>
                <div class="oe-flex oe-items-center oe-gap-3">
              ...
              <div v-if="openPhases[4]" class="oe-px-6 oe-pb-6 oe-space-y-3">
                ...
                >
                  ...
                  <TaskStatusBadge
                    :status="task.status"
                    @change="
                      (newStatus) => updateTaskStatus(phase4Tasks, i, newStatus)
                    "
                  />
                </div>
              </div>
...
const phase1Tasks = ref([
  {
    title: "Resignation submitted via email",
    assigned: "Employee → RM & HR",
    status: "Done",
  },
  {
    title: "Discussion scheduled (RM + HR + Employee)",
    assigned: "HR + Manager",
    status: "Done",
  },
  {
    title: "Decision taken based on discussion",
    assigned: "Manager",
    status: "Done",
  },
  {
    title: "Resignation approved via email (HR in CC)",
    assigned: "Manager",
    status: "Done",
  },
]);
...
const phase2Tasks = ref([
  {
    title: "Mark employee as 'Resigned' in Keka",
    assigned: "HR",
    status: "Done",
  },
  {
    title: "Upload resignation documents in system",
    assigned: "HR",
    status: "Done",
  },
  { title: "Exit officially initiated", assigned: "HR", status: "Done" },
  {
    title: "Leave balances lapsed as per company policy",
    assigned: "System",
    status: "Done",
  },
]);
...
const phase3Tasks = ref([
  {
    title: "KT responsibilities assigned to employee",
    assigned: "Reporting Manager",
    status: "Done",
  },
  { title: "KT documents prepared", assigned: "Vikram", status: "In Process" },
  {
    title: "KT sessions conducted with assigned team members",
    assigned: "Vikram",
    status: "In Process",
  },
  {
    title: "KT reviewed & completion confirmed to HR via email",
    assigned: "Manager",
    status: "Pending",
  },
]);
...
const phase4Tasks = ref([
  {
    title: "LWD calculated based on notice period + KT completion",
    assigned: "HR",
    status: "Pending",
  },
  {
    title: "Official LWD shared with employee via email",
    assigned: "HR",
    status: "Pending",
  },
]);
...
const phase1Progress = computed(() =>
  Math.round((phase1Completed.value / phase1Tasks.value.length) * 100),
);
...
const phase2Progress = computed(() =>
  Math.round((phase2Completed.value / phase2Tasks.value.length) * 100),
);
...
const phase3Progress = computed(() =>
  Math.round((phase3Completed.value / phase3Tasks.value.length) * 100),
);
...
const phase4Progress = computed(() =>
  Math.round((phase4Completed.value / phase4Tasks.value.length) * 100),
);
...
const overallProgress = computed(() =>
  totalTasks.value ? (totalCompleted.value / totalTasks.value) * 100 : 0,
);
...
const exitEmployees = [
  {
    ...
    phase: "Phase 3 – Knowledge Transfer",
  },
  {
    id: 2,
    initials: "MP",
    avatarBg: "oe-bg-pink-100 oe-text-pink-700",
    name: "Meera Patel",
    role: "HR Executive - HR",
    date: "Apr 20, 2026",
    status: "Pending",
    statusClass: "oe-bg-gray-100 oe-text-gray-600",
